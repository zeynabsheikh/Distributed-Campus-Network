...
1.	Server g++ server.cpp -o server -pthread ./server
2.	Client g++ client.cpp -o client -pthread ./client
...
Message Format: TCP Messages: TargetCampus|TargetDept|Message UDP Heartbeat: CampusName|ONLINE
